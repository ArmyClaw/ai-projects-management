...
- ✅ POST /api/v1/tasks（创建任务）← **本次完成**
- 🔄 待完成：PUT /api/v1/tasks/:id、用户认证、积分系统、Skill管理

### 待办列表（后端API）

| 功能 | 优先级 | 预估工时 | 状态 |
|------|--------|---------|------|
| POST /api/v1/tasks | P0 | 15分钟 | ✅ 已完成 |
| PUT /api/v1/tasks/:id | P0 | 15分钟 | 下次迭代 |
| 用户认证API | P1 | 60分钟 | 待规划 |
