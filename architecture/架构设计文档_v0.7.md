...
│  │  ├─ 发起人：项目发布、验收管理、结算                                │   │
│  │  ├─ 参与者：任务大厅、任务执行、成本看板                           │   │
│  │  └─ 通用：用户系统、Skill配置、个人档案                            │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                    │                                      │
│                                    ▼                                      │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
│  │                       CLI工具 (后期可选)                              │   │
│  │  ├─ 本地Skill执行（直接调用Claude API）                            │   │
│  │  ├─ Git深度集成（自动分析commit、PR）                              │   │
│  │  └─ 开发者友好工具链                                               │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│  架构决策：                                                              │
...
├─ 命令行操作
│  ├─ aipm init          # 初始化项目
│  ├─ aipm task list    # 查看任务列表
│  ├─ aipm task claim   # 认领任务
│  ├─ aipm skill run    # 执行Skill
│  └─ aipm git sync    # Git同步
│
├─ 本地Skill执行
│  ├─ 直接调用Claude API
...
│              ▼                     ▼                     ▼              │
│  ┌─────────────────┐   ┌─────────────────┐   ┌─────────────────┐   │
│  │ Claude SDK       │   │ Git Command     │   │ Local File      │   │
│  └─────────────────┘   └─────────────────┘   └─────────────────┘   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
