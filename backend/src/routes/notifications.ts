...
export default async function notificationRoutes(fastify: FastifyInstance): Promise<void> {
  await getNotificationsRoute(fastify)
  await getUnreadCountRoute(fastify)
  await markAsReadRoute(fastify)
  await markAllAsReadRoute(fastify)
  await deleteNotificationRoute(fastify)
}
