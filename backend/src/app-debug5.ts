...
await fastify.register(swagger, { openapi: { info: { title: 'API', version: '1.0..register(swaggerUi, { routePrefix: '/docs0' } } })
await fastify' })
...
console.log('[3] Tasks routes done')

// 认证路由 - 使用 fastify.register
import authRoutes from './routes/auth.js'
await fastify.register(authRoutes, { prefix: '/api/v1/auth' })
console.log('[4] Auth routes done')
